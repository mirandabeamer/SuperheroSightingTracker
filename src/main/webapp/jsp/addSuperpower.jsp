<%-- 
    Document   : addSuperpower
    Created on : Aug 23, 2020, 3:46:29 PM
    ...
    <body>
        <div class="container">
            ...
            <div>
                ...
                <form class="form-horizontal col-lg-4" role="form" action="addSuperpower" method="POST">
                    <div class="form-group">
                        <label for="superpowerName">Name: </label>
                        <div>
                            <input class="form-control" type="text" name="superpowerName" placeholder="Name" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="supwerpowerDesc">Description: </label>
                        <div>
                            <input class="form-control" type="text" name="superpowerDesc" placeholder="Description" required/>
                        </div>
                    </div>
                    <div class="form-group">
